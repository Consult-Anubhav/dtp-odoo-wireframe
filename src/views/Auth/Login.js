...
const Login = () => {
    ...
    return (
        ...
        <div style={{ backgroundColor: '#EEEEEE'}}>
            <div className="container row" style={{minHeight: 'calc(100vh - 380px)'}}>
                <div className="col-7">
                ...
                <div className="col-5">
                    <div className="d-flex justify-content-center align-items-center h-100">
                        <div className="p-4" style={{backgroundColor: 'white'}}>
                            ...
                            <span style={{border: '1px solid #AFB1B6', margin: '0 5px'}}></span>
                            <button type="button" class="btn btn-light" style={{fontSize: '14px'}}>
                                <NavLink to="/signup/role" component={<div></div>} className="text-decoration-none text-black">
                                    Create Account
                                </NavLink>
                            </button>
                        </div>
